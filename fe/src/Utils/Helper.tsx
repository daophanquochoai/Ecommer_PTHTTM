...
// ---------get blog ADMIN----------------
export const getListBlog = async (page: number) => {
    try {
        const text = []
        text.push(`page=${page+1}`)
        return await axios.get(`${ENV.API_BASE}/admin/blogs`+ (text.length > 0 ? '?' + text.join('&') : ''),
            {
                headers : {
                    Authorization : `Bearer ${localStorage.getItem('accessToken')}`
                }
...
export const getBlogDetail = async (id: number) => {
    try {
        return await axios.get(`${ENV.API_BASE}/admin/blogs/detail/${id}`,
            {
                headers : {
                    Authorization : `Bearer ${localStorage.getItem('accessToken')}`
                }
...
export const editBlog = async (id: number, data: object) => {
    try {
        return await axios.patch(`${ENV.API_BASE}/admin/blogs/edit/${id}`,data,
            {
                headers : {
                    Authorization : `Bearer ${localStorage.getItem('accessToken')}`
                }
...
export const addBlog = async (data: object) => {
    try {
        return await axios.post(`${ENV.API_BASE}/admin/blogs/create`,data,
            {
                headers : {
                    Authorization : `Bearer ${localStorage.getItem('accessToken')}`
                }
...
// ---------setting generals------------------
export const settingAboutWebsiteClient = async () => {
    try {
        return await axios.get(`${ENV.API_BASE}/admin/settings/about-website`,
            {
                headers : {
                    Authorization : `Bearer ${localStorage.getItem('accessToken')}`
                }
...
export const settingAboutWebsite = async () => {
    try {
        return await axios.get(`${ENV.API_BASE}/admin/settings/about-website`,
            {
                headers : {
...
export const settingAboutWebsite_PATCH = async (data: object) => {
    try {
        return await axios.patch(`${ENV.API_BASE}/admin/settings/about-website`,data,
            {
                headers : {
                    Authorization : `Bearer ${localStorage.getItem('accessToken')}`
                }
...
export const settingContactInformation_PATCH = async (data: object) => {
    try {
        return await axios.patch(`${ENV.API_BASE}/admin/settings/contact-infomation`,data,
            {
                headers : {
                    Authorization : `Bearer ${localStorage.getItem('accessToken')}`
                }
...
// ---------end setting generals--------------

// --------- contact ADMIN------------
export const getListContact= async (page: number) => {
    const text = []
    text.push(`page=${page+1}`)
    try {
        return await axios.get(`${ENV.API_BASE}/admin/contacts` + (text.length > 0 ? '?' + text.join('&') : ''),
            {
                headers : {
                    Authorization : `Bearer ${localStorage.getItem('accessToken')}`
                }
...
export const getDetailContact= async (id: number) => {
    try {
        return await axios.get(`${ENV.API_BASE}/admin/contacts/detail/${id}`,
            {
                headers : {
                    Authorization : `Bearer ${localStorage.getItem('accessToken')}`
                }
...
export const responseContact= async (id: number, data: object) => {
    try {
        return await axios.post(`${ENV.API_BASE}/admin/contacts/response/${id}`,data,
            {
                headers : {
                    Authorization : `Bearer ${localStorage.getItem('accessToken')}`
                }
...
export const getAllOrders = async (page: number) => {
    try {
        ...
        return await axios.get(`${ENV.API_BASE}/admin/orders` + (text.length > 0 ? '?' + text.join('&') : ''),
            {
                headers : {
                    Authorization : `Bearer ${localStorage.getItem('accessToken')}`
                }
...
//recommend for user
export const recommendForUser = async ( userId : number) => {
    try{
