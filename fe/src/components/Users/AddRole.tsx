...
const bread : object[] = [
    ...
    {
        title : <span className={'text-red-500'}>Add Role</span>
    }
]
                    ...
                    <Form layout="vertical">
                        ...
                        <div className={'flex gap-20'}>
                            <Form.Item label="Permissions">
                                <Checkbox.Group options={permissions} className='flex flex-col' />
                            </Form.Item>
                            <Form.Item label="Modules"> 
                                <Checkbox.Group options={modules} className='flex flex-col' />
                            </Form.Item>
                        </div>
