...
const FooterTop = () => {
    ...
    const {contactInformation} = useContext(AppContext)

    return (
        <div className={'flex flex-col md:flex-row gap-8'}>
            <div className={'grid gap-2'}>
                <p className={'font-bold text-xl'}>Call To Order</p>
                <h2 className={'text-3xl text-red-500'}>{contactInformation.supportPhoneNumber}</h2>
                ...
                <p className={'text-gray-400'}><span className={'font-bold text-base text-black'}>Address : </span> {contactInformation.address}</p>
                <p className={'text-gray-400'}><span className={'font-bold text-base text-black'}>Email : </span>{contactInformation.contactEmail}</p>
